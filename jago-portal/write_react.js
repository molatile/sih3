...
const write = (file, content) => {
    const fullPath = path.join('D:/ai man/sih3/jago-portal/src', file);
    ...
    return (
        <section className="min-h-screen bg-gray-50 flex-col md:flex-row h-full flex w-full">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden min-w-0">
                ...
                <div className="flex-1 overflow-y-auto p-4 lg:p-8" id="tab-content-container">
                    {children}
                </div>
            </main>
        </section>
...
write('components/layout/Sidebar.jsx', Sidebar);
write('components/layout/DashboardShell.jsx', DashShell);

console.log("Written shell and sidebar.");
