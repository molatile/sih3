...
with open(os.path.join(out_dir, 'components/layout/Sidebar.jsx'), 'w', encoding='utf-8') as f: f.write(sidebar)
with open(os.path.join(out_dir, 'components/layout/DashboardShell.jsx'), 'w', encoding='utf-8') as f: f.write(dash)
